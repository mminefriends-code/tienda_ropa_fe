        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              disabled={isLoading}
            />
            {errors.password && <p className="text-red-500 text-sm mt-1">Requerido</p>}
          </div>
          ...
          <p className="text-center text-gray-500">
            ¿No tienes cuenta? <Link to="/registro" className="text-primary-600 hover:text-primary-700 font-medium">Regístrate</Link>
          </p>
        </form>
